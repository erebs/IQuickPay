...
public class ProductH extends RecyclerView.Adapter<ProductH.MyViewHolder>
{
    Context ctx;
    private List<Products> mProducts = new ArrayList<>();
    Products Products;

    public ProductH(Context ctx)
    {
        this.ctx = ctx;
    }
    ...
    {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_producth_layout, parent,false);
